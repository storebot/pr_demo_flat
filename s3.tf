...
resource "aws_s3_bucket_policy" "s3userVersioningMFAOnly" {
...
resource "aws_s3_bucket_policy" "s3BucketNoWebsiteIndexDoc" {
...
resource "aws_s3_bucket_policy" "s3BucketSseRulesWithKmsNull" {
...
resource "aws_s3_bucket_policy" "s3VersioningMfaFalse" {
...
resource "aws_s3_bucket_policy" "noS3BucketSseRules" {
...
resource "aws_s3_bucket_policy" "allUsersReadWriteAccess" {
...
resource "aws_s3_bucket_policy" "allUsersWriteAccess" {
...
resource "aws_s3_bucket_policy" "authUsersReadAccess" {
...
resource "aws_s3_bucket_policy" "s3userVersioningOnly" {
...
resource "aws_s3_bucket_policy" "allUsersReadAccess" {
